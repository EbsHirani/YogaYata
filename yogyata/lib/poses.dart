...
import 'package:yogyata/inference.dart';
import 'package:yogyata/yoga_card.dart';
...
class Poses extends StatelessWidget {
  ...
  void _onSelect(BuildContext context) async {
    String customModelName = "assets/models/model_mn.tflite";
    Navigator.push(
      context,
      MaterialPageRoute(
